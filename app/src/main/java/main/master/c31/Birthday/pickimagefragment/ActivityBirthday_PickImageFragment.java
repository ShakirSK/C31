package main.master.c31.Birthday.pickimagefragment;
 ...
 * {@link ActivityBirthday_PickImageFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ActivityBirthday_PickImageFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ActivityBirthday_PickImageFragment extends Fragment {
    ...
    public static String birthdayimage="";

    public ActivityBirthday_PickImageFragment() {
    ...
    public static ActivityBirthday_PickImageFragment newInstance(String param1, String param2) {
        ActivityBirthday_PickImageFragment fragment = new ActivityBirthday_PickImageFragment();
...
// we check that the fragment is becoming visible
    ...
    private void showUriList(List<Uri> uriList) {
        ...
        if(uriList.isEmpty()){
            ...
            birthdayimage = String.valueOf(uriList.get(0));
        }
